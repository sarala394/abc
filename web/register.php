                ...
                <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" role="form" class="php-email-form" novalidate>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" class="form-control border border-1 border-dark" name="address_line1" id="address_line1" value="<?= @$address_line1 ?>" placeholder="Address Line 1" required>
                        </div>
                        <div class="form-group mt-3">
                            <label for="address_line2">Address Line 2</label>
                            <input type="text" class="form-control border border-1 border-dark" name="address_line2" id="address_line2" value="<?= @$address_line2 ?>" placeholder="Address Line 2" required>
                        </div>
                        <div class="form-group mt-3">
                        ...
                        <div class="form-group mt-3">
                            ...
                            ?>
                            <label for="districts">District :</label>
                            <select name="dsarea" id="district" class="form-select form-select-lg mb-3 border border-1 border-dark" aria-label="Large select example">
...
<script>
    function loadDSArea() {
        ...
        if (districtId) {
            ...
            $.ajax({
                url: 'get_divisional_secretariats.php?districtId=' + districtId,
                type: 'GET',
